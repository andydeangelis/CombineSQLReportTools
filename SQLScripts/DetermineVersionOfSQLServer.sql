...
SELECT  @SPInfo = 
		...
		CASE @ProductName
				WHEN 'SQL Server 2017' THEN CASE @ProductVersion
												WHEN '14.0.3008.27' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of RTM:  CU2, <https://support.microsoft.com/en-us/kb/4052574>'
											END
			    WHEN 'SQL Server 2016' THEN 
											CASE @ProductVersion
...
BEGIN
	...
	--2017
	IF (@ProductLevel = 'RTM') AND (@ProductVersion < '14.0.3008.27')
	BEGIN
		SET @CumulativeUpdate = 'CU2'; SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4052574';
	END			
